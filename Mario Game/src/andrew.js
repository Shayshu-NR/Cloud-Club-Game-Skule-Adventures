...
function create() {
    ...
    //~~~~~~Door~~~~~~~~~~~~~
    //const door_body;
    const door_body = door.create(1000, 500, "door");
    ...
    player.animations.add(
        "left_blink", [10, 20, 9, 20, 8, 20, 10, 20, 7, 20, 6, 20, 10, 20],
        10,
        true
    );
    player.animations.add(
        "right_blink", [0, 20, 1, 20, 2, 20, 0, 20, 3, 20, 4, 20, 0, 20],
        10,
        true
    );
    ...
    walking_astronaut.to({ x: 700, y: 386 },
        10000,
        null,
        true,
        0,
...
function render() {
    this.game.debug.text(
        `Debugging Phaser ${Phaser.VERSION}`,
        200,
        20,
        "yellow",
        "Segoe UI"
