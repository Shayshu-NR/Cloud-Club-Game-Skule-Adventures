LEVEL6 = {}
LEVEL6.Lassonde_part_1 = function(game) {}
LEVEL6.Lassonde_part_1.prototype = {
    preload: function() { // Load & Define our game assets
    ...
    create: function() {
        ...
        doorx = 2884;
        doory = 400;
        const door_body = door.create(2884, 400, "door");
        //~~~~~~~~~~~~~~~~
    },
    ...
    update: function() {
        ...
        if (player.position.x >= doorx - 20 && player.position.x <= doorx + 20) {
            if (cursors.up.isDown) {
                ...
                game.state.start("Lassonde_part_2");
            }
        }
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
